...
class ViewByIDServletTest {
    ...
    private final ViewByIDServlet servlet = new ViewByIDServlet();
    ...
    @Test
    void doGet_blankId_sendsBadRequest() throws ServletException, IOException {
    ...
    void doGet_employeeFound_setsAttributeAndForwards() throws ServletException, IOException {
        ...
        when(request.getRequestDispatcher("/WEB-INF/views/employeeDetail.jsp")).thenReturn(dispatcher);
